  ...
  <form action="{{ route('transportasi.store') }}" method="POST">
    ...
    <div class="card-body">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="name" name="name" value="{{ $transportasi->name }}" required />
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="jumlah" name="jumlah" onkeypress="return inputNumber(event)" value="{{ $transportasi->jumlah }}" required />
      </div>
      <div class="form-group">
